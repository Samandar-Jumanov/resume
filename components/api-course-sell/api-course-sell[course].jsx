...
import { courseEndpoints, courseMiddlewares, courseBaseUrl } from "./endpoints/course";
...
const APICourseDocs = () => {
  ...
  return (
    <div className="container mx-auto p-8">
      <h1 className="text-3xl font-bold mb-4">Docs course sell | User Courses </h1>

      <h2 className="text-2xl font-semibold mt-6 mb-4">Base URL</h2>
      <code className="bg-gray-200 p-2 rounded-md">{courseBaseUrl}</code>

      <h2 className="text-2xl font-semibold mt-6 mb-4">Endpoints</h2>

      {courseEndpoints.map((endpoint, index) => (
      ...
      {courseMiddlewares.map((middleware, index) => (
        <div key={index} className="my-4">

...
import { orderEndpoints, orderMiddlewares, orderBaseUrl } from "./endpoints/orders";
...
const APIOrderDocs = () => {
  ...
  return (
    <div className="container mx-auto p-8">
      <h1 className="text-3xl font-bold mb-4">Docs course sell | Orders</h1>

      <h2 className="text-2xl font-semibold mt-6 mb-4">Base URL</h2>
      <code className="bg-gray-200 p-2 rounded-md">{orderBaseUrl}</code>
      ...
      {orderMiddlewares.map((middleware, index) => (
        <div key={index} className="my-4">
